...
for line_data in metro.lineas_with_data.values():
...
print("##############################################################\n")
print("Hi, Welcome to the efficient travelling system in the metro")
print("Please input every word with a Capital letter\n")
while(decision != "N"):
    estacionInicial1 = input("What station is your initial point? ")
    estacionFinal1 = input("Where are you going to? ")
    ...
    decision = input("Do you want to make another trip? (Y/N)")
